...
class ET_Builder_Module_Product_Meta extends ET_Builder_Module {
	function init() {
		$this->name            = esc_html__( 'Product Meta', 'et_builder' );
		$this->slug            = 'et_pb_product_meta';
...
new ET_Builder_Module_Product_meta;  