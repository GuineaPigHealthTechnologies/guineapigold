                                ...
                                <tr class="row">
                                    <td class="row th">
                                        <div class="col-title">
                                            ...
                                            <span class="description">
                                                <?php _e('Select the user role you want to give access to the staging site. You can select multiple roles by holding CTRL or ⌘ Cmd key while clicking. <strong>This does not affect previously created staging sites and you need to create a new staging site if you want to change the authentication of it.</strong', 'wpstg'); ?>
                                            </span>
                                        </div>
                                    </td>
                                    <td>
