...
class Administrator extends InjectionAware {
   ...
   public function addMenu() {
      ...
      add_menu_page(
              "WP-Staging", __( "WP Staging Pro", "wpstg" ), "manage_options", "wpstg_clone", array($this, "getClonePage"), $logo
      );

      // Page: Clone
      add_submenu_page(
              "wpstg_clone", __( "WP Staging Jobs", "wpstg" ), __( "Sites", "wpstg" ), "manage_options", "wpstg_clone", array($this, "getClonePage")
      );
      ...
      if( class_exists( 'WPStaging\Backend\Pro\Licensing\Licensing' ) && (false === get_option('wpstg_is_staging_site') || 'false' == get_option('wpstg_is_staging_site'))) {
         // Page: License
         add_submenu_page(
