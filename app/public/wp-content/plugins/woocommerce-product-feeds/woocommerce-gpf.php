...
// The current version.
define( 'WOOCOMMERCE_GPF_VERSION', '7.4.3' );
 ...
 */
require_once( 'woocommerce-gpf-import-export-integration.php' );
...
require_once( dirname( __FILE__ ) . '/woocommerce-gpf-template-functions.php' );
