							...
							foreach($row_value as $row_k => $row_v){
								...
								<tr class="rowCount">
									...
									<td>
										...
										<?php
										if($project['fields'] == "google_shopping"){
										?>
											<span class="ui-icon ui-icon-info opener" id="<?php print "$dialog_value";?>"></span>
										<?php
										}
										?>
									</td>
							...
							<tr class="rowCount">	
								...
								<td>
									...
									<?php }
                                                                        if($project['fields'] == "google_shopping"){
                                                                        ?>
										<span class="ui-icon ui-icon-info opener" id="<?php print "$attribute_array[attribute]";?>"></span>
									<?php
									}
									?>
								</td>
