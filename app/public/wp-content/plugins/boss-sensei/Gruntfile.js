...
module.exports = function ( grunt ) {
    ...
    grunt.initConfig( {
        ...
        uglify: {
            ...
            frontend: {
                files: {
                    'assets/js/sensei.min.js': [ 'assets/js/sensei.js' ],
                }
            },
        },
        /*
        ...
        checktextdomain: {
            options: {
                text_domain: [ 'boss-sensei', 'buddypress', 'bbpress', 'woothemes-sensei', 'wcvendors-pro', 'woocommerce' ], //Specify allowed domain(s)
        ...
        makepot: {
            target: {
                options: {
                    ...
                    potFilename: 'boss-sensei.pot', // Name of the POT file.
