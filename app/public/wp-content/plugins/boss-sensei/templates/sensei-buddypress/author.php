	...
	<section id="primary" class="site-content">
        ...
        <header class="archive-header page-header smaller-padding">
            <h1 class="archive-title main-title">
               <?php printf( __( 'Author Archives: %s', 'boss-sensei' ), '<span class="vcard"><a class="url fn n" href="' . esc_url( get_author_posts_url( get_the_author_meta( "ID" ) ) ) . '" title="' . esc_attr( get_the_author() ) . '" rel="me">' . get_the_author() . '</a></span>' ); ?>
            </h1>
		...
		<?php if ( have_posts() ) : ?>
			...
			<div class="author-info table smaller-padding">
				...
				<div class="author-description table-cell">
					<h2><?php printf( __( 'About %s', 'boss-sensei' ), get_the_author() ); ?></h2>
