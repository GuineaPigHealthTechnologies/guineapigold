...
add_filter( 'bboss_licensed_packages', 'slearner_sensei_register_licensed_package' );
function slearner_sensei_register_licensed_package( $packages=array() ){
    $this_package = array(
        'id'        => 'slearner_sensei',
        'name'      => __( 'Social Learner - Sensei', 'boss-sensei' ),
        'products'  => array(
            ...
            'SLEARNER_SENSEI' => array(
                'software_ids'  => array( 'SLEARNER_SENSEI_UPGRADE', 'SLEARNER_SENSEI_1S', 'SLEARNER_SENSEI_5S', 'SLEARNER_SENSEI_20S' ),
    ...
    $packages['slearner_sensei'] = $this_package;
    return $packages;
}

add_filter( 'bboss_updatable_products', 'slearner_sensei_register_updatable_product' );
function slearner_sensei_register_updatable_product( $products ){
    ...
    $products['SLEARNER_SENSEI'] = array(
        ...
        'path'          => 'boss-sensei/boss-sensei.php',
        'id'            => 91,
        'software_ids'  => array( 'SLEARNER_SENSEI_UPGRADE', 'SLEARNER_SENSEI_1S', 'SLEARNER_SENSEI_5S', 'SLEARNER_SENSEI_20S' ),
        'type'          => 'plugin'
    );
...
if( !function_exists( 'bboss_notice_install_updater' ) ) {
    ...
    function bboss_notice_install_updater(){
        ...
        $notice_install_buddyboss_updater = sprintf( __( "To receive updates for BuddyBoss products, please install and activate the plugin %s", 'boss-sensei' ), $plugin_link );
